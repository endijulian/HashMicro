        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <strong class="card-title">Edit Master STNK</strong>
                    <a href="{{ route('stnk.index') }}" class="float-right btn btn-info btn-sm"><i class="fa fa-chevron-circle-left"></i> Back</a>
                </div>
                <div class="card-body">
                    <form action="{{ route('stnk.update',$stnk->id) }}" method="post" novalidate="novalidate">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="card-body col-lg-4">
                            <div class="form-group">
                                <div class="form-group accordion">
                                    ...
                                    <input id="no_stnk" name="no_stnk" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $stnk->no_stnk }}">
                                    ...
                                    <label for="jenis_kendaraans_id" class="control-label mb-1">Jenis Kendaraan<span class="badge">*</span></label>
                                        <select name="jenis_kendaraans_id" id="jenis_kendaraans_id" class="form-control" required>
                                            ...
                                            @foreach ($jenisKendaraan as $value)
                                                <option value="{{ $value->id }}" @if($value->id == $stnk->jenis_kendaraans_id) selected @endif>{{ $value->jenis_kendaraan }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group accordion">
                                    ...
                                    <input id="silinder" name="silinder" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $stnk->silinder }}">
                                    <p class="text-danger">{{ $errors->first('silinder') }}</p>
                                </div>
                                <div class="form-group accordion">
                                    <label for="tnkb" class="control-label mb-1">TNKB<span class="badge">*</span></label>
                                    <input id="tnkb" name="tnkb" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $stnk->tnkb }}">
                                    <p class="text-danger">{{ $errors->first('tnkb') }}</p>
                                </div>
                                <div class="form-group accordion">
                                    <label for="pkb" class="control-label mb-1">PKB<span class="badge">*</span></label>
                                    <input id="pkb" name="pkb" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $stnk->pkb }}" placeholder="Rp">
                                    <p class="text-danger">{{ $errors->first('pkb') }}</p>
                                </div>
                                <div class="form-group accordion">
                                    <label for="nama_stnk" class="control-label mb-1">Nama STNK<span class="badge">*</span></label>
                                    <input id="nama_stnk" name="nama_stnk" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $stnk->nama_stnk }}">
                                    <p class="text-danger">{{ $errors->first('nama_stnk') }}</p>
                                </div>
                                <div class="form-group accordion">
                                    <label for="nilai_pajak_stnk" class="control-label mb-1">Nilai Pajak STNK</label>
                                    <input id="nilai_pajak_stnk" name="nilai_pajak_stnk" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $stnk->nilai_pajak_stnk }}" placeholder="Rp">
                                ...
                                <div class="form-group accordion">
                                    ...
                                    <select name="status_id" id="status_id" class="form-control">
                                        @foreach ($status as $value)
                                            <option value="{{ $value->id }}" @if ($value->id == $stnk->status_id) selected @endif>{{ $value->status }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="card-body col-lg-4">
                            <div class="form-group">
                                <div class="form-group accordion">
                                    ...
                                    <input id="no_polisi" name="no_polisi" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $stnk->no_polisi }}">
                                    <p class="text-danger">{{ $errors->first('no_polisi') }}</p>
                                </div>
                                <div class="form-group accordion">
                                    <label for="model" class="control-label mb-1">Model<span class="badge">*</span></label>
                                    <input id="model" name="model" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $stnk->model }}">
                                    <p class="text-danger">{{ $errors->first('model') }}</p>
                                </div>
                                <div class="form-group accordion">
                                    <label for="no_mesin" class="control-label mb-1">No Mesin<span class="badge">*</span></label>
                                    <input id="no_mesin" name="no_mesin" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $stnk->no_mesin }}">
                                ...
                                <div class="form-group accordion">
                                    ...
                                    <input id="swdkllj" name="swdkllj" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $stnk->swdkllj }}">
                                ...
                                <div class="form-group accordion">
                                    ...
                                    <input id="bahan_bakar" name="bahan_bakar" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $stnk->bahan_bakar }}">
                                    <p class="text-danger">{{ $errors->first('bahan_bakar') }}</p>
                                </div>
                                <div class="form-group accordion">
                                    <label for="warna" class="control-label mb-1">Warna<span class="badge">*</span></label>
                                    <input id="warna" name="warna" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $stnk->warna }}">
                                    <p class="text-danger">{{ $errors->first('warna') }}</p>
                                </div>
                                <div class="form-group accordion">
                                    <label for="pajak_jasa" class="control-label mb-1">Pajak Jasa</label>
                                    <input id="pajak_jasa" name="pajak_jasa" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $stnk->pajak_jasa }}" placeholder="Rp">
                        ...
                        <div class="card-body col-lg-4">
                            <div class="form-group">
                                <div class="form-group accordion">
                                    ...
                                    <input id="merk" name="merk" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $stnk->merk }}">
                                ...
                                <div class="form-group accordion">
                                    ...
                                    <input id="no_rangka" name="no_rangka" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $stnk->no_rangka }}">
                                ...
                                <div class="form-group accordion">
                                    ...
                                    <input id="masa_berlaku" name="masa_berlaku" type="date" class="form-control" aria-required="true" aria-invalid="false" value="{{ $stnk->masa_berlaku }}">
                                ...
                                <div class="form-group accordion">
                                    ...
                                    <input id="jasa_perpanjang" name="jasa_perpanjang" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $stnk->jasa_perpanjang }}" placeholder="Rp">
                                ...
                                <div class="form-group accordion">
                                    ...
                                    <input id="tahun_kendaraan" name="tahun_kendaraan" type="number" class="form-control" aria-required="true" aria-invalid="false" value="{{ $stnk->tahun_kendaraan }}">
                                    <p class="text-danger">{{ $errors->first('tahun_kendaraan') }}</p>
                                </div>
                                <div class="form-group accordion">
                                    <label for="no_bpkb" class="control-label mb-1">No BPKP</label>
                                    <input id="no_bpkb" name="no_bpkb" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $stnk->no_bpkb }}">
                                ...
                                <div class="form-group accordion">
                                    ...
                                    <input id="pajak_stnk" name="pajak_stnk" type="date" class="form-control" aria-required="true" aria-invalid="false" value="{{ $stnk->pajak_stnk }}">
